...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_DEFAULT] = LAYOUT(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5,                                   KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC,
                        ...
                        KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_HOME,                KC_MUTE, KC_N, KC_M, KC_MINS, KC_EQL, KC_COMM, KC_DOT,
                            KC_LGUI, KC_LALT, MO(1), KC_SPC,                               KC_ENT,  MO(2), KC_RALT, KC_RCTL),

	[_LOWER] = LAYOUT(KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,                            KC_MINS, KC_EQL, KC_PSCR, KC_SCRL, KC_PAUS, KC_TRNS,
                      KC_TRNS, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,                            KC_LBRC, KC_RBRC, KC_INS, KC_HOME, KC_PGUP, KC_TRNS,
                      KC_TRNS, KC_CAPS, KC_MYCM, KC_CALC, KC_F11, KC_F12,                         KC_QUOT, KC_NUHS, KC_DEL, KC_END, KC_PGDN, KC_RSFT,
	...
	[_RAISE] = LAYOUT(KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,               KC_NO, KC_NUM, KC_P7, KC_P8, KC_P9, KC_PSLS,
                      KC_TRNS, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,               KC_NO, KC_PEQL, KC_P4, KC_P5, KC_P6, KC_PAST,
                      KC_TRNS, KC_CAPS, KC_MYCM, KC_CALC, KC_F11, KC_F12,               KC_NO, KC_UP, KC_P1, KC_P2, KC_P3, KC_PMNS,
